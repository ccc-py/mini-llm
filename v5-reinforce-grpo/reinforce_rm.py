...
import json as _j
_j.dump({"method":"REINFORCE(RM)","seen_before":round(init_seen*100,1),"seen_after":round(final_seen*100,1),"unseen_before":round(init_unseen*100,1),"unseen_after":round(final_unseen*100,1)}, open('metrics_rm.json','w'))
print("=" * 45)
